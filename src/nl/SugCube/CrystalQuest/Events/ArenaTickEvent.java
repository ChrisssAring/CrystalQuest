...
public class ArenaTickEvent extends Event {
	...
	/**
	 * Constructor.
	 * @param a (Arena) The current arena
	 * @param o (int) The clock before the tick
	 * @param n (int) The clock after the tick
	 * @param ig (boolean) True if it is a result in-game, false if the arena is
	 * pre-game.
	 */
