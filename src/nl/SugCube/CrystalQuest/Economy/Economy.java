...
public class Economy {
	 ...
	 * @param plma (PluginManager) The plugin manager of the plugin.
	 */
	...
	public ItemStack getItemBalance(Player p) {
		...
		im.setDisplayName(ChatColor.GREEN + "Crystals: " + ChatColor.GOLD + getBalance().getBalance(p.getName(), false));
	 ...
	 * @param lvl (int) The level to upgrade to.
	 */
	public int getCosts(int lvl) {
		switch (lvl) {
		case 1: return COST_LVL_1;
		case 2: return COST_LVL_2;
		case 3: return COST_LVL_3;
		case 4: return COST_LVL_4;
		case 5: return COST_LVL_5;
		default: return 0;
		}
	}
	 ...
	 * @param upgrade (String) The upgrade's name.
	 ...
	 * @param p (Player) The targeted player.
	 * @param amount (int) The amount of crystals to add.
	 * @return (String) The message to be displayed to the player. OR null when there is
	 * no message set.
	 */
