...
public class Balance {
	 ...
	 * @param p (Player) The player you want to set the balance for.
	 * @param newBalance (int) The new balance (greather than zero).
	 */
	 ...
	 * @param p (Player) The player to edit the balance.
	 * @param amount (int) The amount of crystals to add (negative number to remove).
	 * @param showMessage (boolean) When true, a notification will be sent to the player.
	 ...
	 */
	public int getBalance(String name, boolean createAccount) {
